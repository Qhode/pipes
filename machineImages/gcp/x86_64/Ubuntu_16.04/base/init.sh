...
readonly NODE_TARBALL_URL="--user=$BBS_USERNAME --password="$BBS_API_KEY" https://git.jfrog.info/rest/api/latest/projects/PIP/repos/nodeinit/archive?format=tgz"
readonly REQKICK_DOWNLOAD_URL="--user=$BBS_USERNAME --password="$BBS_API_KEY" https://git.jfrog.info/rest/api/latest/projects/PIP/repos/reqkick/archive?format=tgz"
readonly EXECTEMPLATES_DOWNLOAD_URL="--user=$BBS_USERNAME --password="$BBS_API_KEY" https://git.jfrog.info/rest/api/latest/projects/PIP/repos/exectemplates/archive?format=tgz"
...
source "$NODE_SCRIPTS_LOCATION/$ARCHITECTURE/$OS/$INIT_SCRIPT_NAME"
